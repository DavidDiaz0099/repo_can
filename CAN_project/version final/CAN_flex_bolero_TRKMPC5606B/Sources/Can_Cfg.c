...
CAN_ConfigMsgType bios_cnf_can_messages[] = {
  ...
  *      TX / RX
  */
	{ 0, CNF_CAN_CH_RX, CNF_CAN_DATA_FRAME, CNF_CAN_IDE_STD, 0x308,         0x308,                Telltel}, //Veh_Speed
	{ 1, CNF_CAN_CH_RX, CNF_CAN_DATA_FRAME, CNF_CAN_IDE_STD, 0x202,         0x202,             Indicators},
