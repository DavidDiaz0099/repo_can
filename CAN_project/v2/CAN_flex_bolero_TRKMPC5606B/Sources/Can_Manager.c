...
void Indicators(CAN_MessageDataType CanMessage1)
{
	...
	Directional_Status = CanMessage1.msg_data_field[0]; //
	Oil_low_Status	= CanMessage1.msg_data_field[1]; //
	High_Beams_Status = CanMessage1.msg_data_field[2]; 
	HandBrake_Status = CanMessage1.msg_data_field[3]; 
